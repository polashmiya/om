...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer(
                    "Server=POLASH-558442;Database=OfficeManagement;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True"
                );
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BloodGroup>(entity =>
            {
                ...
                entity.HasIndex(e => e.BloodGroupName, "UQ__bloodGro__24092C97DB3F364C").IsUnique();

                entity
                    .Property(e => e.BloodGroupId)
                    .ValueGeneratedNever()
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.Property(e => e.Emaill).HasMaxLength(50).HasColumnName("emaill");
                ...
                entity.Property(e => e.Nid).HasMaxLength(50).IsUnicode(false).HasColumnName("nid");
            ...
            modelBuilder.Entity<Gender>(entity =>
            {
                ...
                entity.HasIndex(e => e.GenderName, "UQ__gender__14B63E73EE55F938").IsUnique();

                entity.Property(e => e.GenderId).ValueGeneratedNever().HasColumnName("genderId");
            ...
            modelBuilder.Entity<Religion>(entity =>
            {
                ...
                entity.HasIndex(e => e.ReligionName, "UQ__religion__AD37F20CBF9D4FAE").IsUnique();
